...
df_agg = df_agg[(df_agg["n_carbon"] <= 36) & (df_agg["cutoff"] == CUTOFF)]
...
ax_deviation.set_ylabel(r"$\Delta E - \Delta E_{\text{FiRE}}$ / m$E_\text{h}$")
